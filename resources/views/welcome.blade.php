...
<body>
                ...
                @foreach ($data as $item)
                    <div class="blog-item p-4">
                        <div class="blog-img mb-4">
                          <iframe 
    class="w-100 rounded" 
    src="https://www.youtube.com/embed/{{ $item->thumbnail }}" 
    ...
    allowfullscreen>
                            ...
                            <div class="blog-title">
                                <a href="#" class="btn">{{$item->category}}</a>
                            </div>
                        </div>
                        <a href="#" class="h4 d-inline-block mb-3">{{$item->title}}</a>
                        <div class="mb-4">{{$item->description}}
                        </div>
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ms-3">
                                <h5>{{$item->author}}</h5>
                                <p class="mb-0">{{$item->publication_date}}</p>
                            </div>
                        </div>
                    </div>
                @endforeach
